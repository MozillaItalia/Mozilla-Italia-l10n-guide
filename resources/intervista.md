...
Facciamo un esempio considerando le istruzioni per impostare un account email. Nelle istruzioni leggi “Premi il pulsante Accedi”, mentre nell’interfaccia il pulsante è chiamato “Entra” (entrambe validissime traduzioni di “Log in”). 
...
Quando si parla di tecnologia, in particolare per quanto riguarda nuove tecnologie, sbagliare è (pur)troppo facile. Mi viene in mente una discussione che abbiamo avuto riguardo alla traduzione di un articolo su [MDN]().
...
Avevamo già in mente di riorganizzare la documentazione per i localizzatori e rivedere il nostro metodo di lavoro, ma è stato Edoardo, Reps Regional Coach nonché uno dei *mentor* del programma, a capire che la guida aveva le potenzialità per entrare nell’OLT.
...
- Issue per i commenti https://github.com/kitsunenosaraT/Mozilla-Italia-l10n-guide/issues/31 Questi sono i tipi di file con cui noi traduttori abbiamo ordinariamente a che fare. Sono gradite anche proposte o richieste di aggiunta di file utilizzati nello sviluppo.
